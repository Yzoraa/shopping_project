...
<h2>:star: 실행화면</h2>
<div font-size="15px">[ Main Page ]</div>
<p>- 이미지 슬라이드 무한 반복</p>
<p>- 하트 이미지 클릭시 아이템 정보 로컬스토리지에 저장</p><br />
<p>- 상세 페이지 : 장바구니 버튼 클릭시 아이템 정보 로컬스토리지에 저장</p>
<p>- 장바구니 페이지 : 장바구니에 담은 아이템 출력</p>
<p>- 좋아요 페이지 : 하트 이미지 클릭한 아이템 출력</p>
<img src="">
<br /><br />

<div font-size="15px">[ Manager Page ]</div>
<p>- 저장기능 : 아이템 정보 로컬스토리지에 저장 (ID 중복 불가능, 이미지 랜덤 출력)</p>
<img src="https://github.com/user-attachments/assets/3713b072-e463-4501-be7b-6116cc67dc37"><br />
<p>- 수정기능 : 등록된 내용 수정</p>
<p>- 삭제기능 : 클릭한 버튼이 있는 행 삭제</p>
